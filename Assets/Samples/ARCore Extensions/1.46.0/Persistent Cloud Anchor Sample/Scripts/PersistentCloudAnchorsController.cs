...
namespace Google.XR.ARCoreExtensions.Samples.PersistentCloudAnchors
{
    ...
    public class PersistentCloudAnchorsController : MonoBehaviour
    {
        ...
        [SerializeField] public object EarthManager;
        ...
        {
            Debug.Log("Host button clicked."); // Debug log to check if the method is called
        ...
        public List<string> GetAllSavedCloudAnchorIds()
        {
            // Load all previously saved Cloud Anchor histories
            var cloudAnchorHistories = LoadCloudAnchorHistory().Collection;
    
            // Extract just the Cloud Anchor IDs
            return cloudAnchorHistories.Select(history => history.Id).ToList();
        }
