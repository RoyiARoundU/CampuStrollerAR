...
namespace Google.XR.ARCoreExtensions.Samples.PersistentCloudAnchors
{
    ...
    public class ResolveMenuManager : MonoBehaviour
    {
        ...
        public void SelectAllAnchors()
        {
            ...
            for (int i = 0; i < _history.Collection.Count; i++)
            {
                allIndices.Add(i);
            }

            // Manually set the selected values
            Multiselection.SelectedValues = allIndices;

            // Trigger the selection changed method to update ResolvingSet
            OnResolvingSelectionChanged();
        }
