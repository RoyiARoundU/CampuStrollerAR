...
[RequireComponent(typeof(ARCloudAnchorManager))]


public class ARPlacementManager : MonoBehaviour
{
    //s[SerializeField] private GameObject AR_object;
    [SerializeField] private GameObject placedPrefab = null;
    [SerializeField] private GameObject placedGameObject;
    ...
    { 
        ...
        { 
            ...
            //    ARCloudAnchorManager.Instantiate(anchor);
                ARCloudAnchorManager.Instantiate(QueueAnchor.Anchor);
            }
        }
...
internal class QueueAnchor
{
    public static Object Anchor { get; }
}
